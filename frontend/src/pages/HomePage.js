...
/* Daniel King's container style const below this comment until sections begin */
  ...
  return (
    <div >
    <h1>Welcome to the Home Page!</h1>  {/* this is behind the nav bar... is it deprecated? */}
    {/* Section 1 Begin */}
            ...
            <div style={contactSubsectionContainerStyle}>
              ...
              <div style={{flex: 'display'}}>
                ...
                <body style={{...{display: 'flex', flexDirection: 'column', justifyContent: 'center'}}}>
                  ...
                  <body>Email: <a href="mailto:info@jacenterprises.com">info@jacenterprises.com</a></body>
                  <body>Social Media: @JacAdventures</body>
                  <body>Website: <a href="www.jacenterprises.com">www.jacenterprises.com</a></body>
