...
const ArtQuestionComponent = () => {
  ...
  const handleButtonClick = async () => {
    try {
      const response = await fetch('http://localhost:8080/api/questions/art/random');
  ...
  const backButtonStyle = {
    ...
    return (
      ...
      {!quizStarted && <div style={introTextStyle}>Set out on a colorful journey through our art trivia game designed just for you! Discover famous paintings, meet imaginative artists, and unleash your creativity. Fun and learning blend in every question!</div>}
