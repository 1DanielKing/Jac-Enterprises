...
const HistoryQuestionComponent = () => {
  ...
  const handleSubmit = () => {
    ...
    setResult(isCorrect ? 'Correct, good job!' : 'Incorrect, try again!');
  };

  const handleNextQuestion = async () => {
    if (result !== 'Correct, good job!') {
...
const backButtonStyle = {
  ...
  return (
    ...
    {!quizStarted && <div style={introTextStyle}>Embark on a thrilling and inquisitive adventure through time in our history trivia game! Explore fascinating stories, meet legendary figures, and uncover the secrets of the past. Fun awaits curious minds!</div>}
